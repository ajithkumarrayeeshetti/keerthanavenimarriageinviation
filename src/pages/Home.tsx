    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="gold-divider w-32 sm:w-40 my-5 sm:my-6">
            <span className="gold-divider-marker" />
          </div>
          ...
          >
            <div className="relative w-full max-w-sm">
              <img
                ...
                className="w-full h-[320px] sm:h-[420px] object-contain rounded-2xl border-4 border-white shadow-xl"
              />
